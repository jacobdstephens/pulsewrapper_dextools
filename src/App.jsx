          ...
          {isConnected && (
            <>
              ...
              <div className="prices">
                <div>
                  <div>${plsPrice.toFixed(2)}</div>
                  <div>PLS Price</div>
                </div>
    
                <div>
                  <div>${wethPrice.toFixed(2)}</div>
                  <div>WETH Price</div>
                </div>
              </div>
              <div className="chart-container">
                <iframe
                  ...
                  src={`https://www.dextools.io/widget-chart/en/pulse/pe-light/0x6b7a5b3754c15b8948f8c100b626b844ab6b44b5?theme=${darkMode ? 'dark' : 'light'}&chartType=2&chartResolution=30&drawingToolbars=false`}
                ></iframe>
              </div>
